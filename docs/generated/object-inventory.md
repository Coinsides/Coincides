...
> 部分晚期表被回填进 `schema.sql`（48 张），部分没有（29 张）。
...
| 10 | `board_text_ranges` | 059_v13_board_text_ranges | ✅ |
| 11 | `board_viewport_bookmarks` | 066_v13_board_viewport_bookmarks | ✅ |
| 12 | `board_visuals` | 057_v13_boards | ✅ |
| 13 | `boards` | 057_v13_boards | ✅ |
| 14 | `canvas_assets` | 041_v2_canvas_image_assets | — |
| 15 | `canvas_frames` | 023_v2_learning_canvas | ✅ |
| 16 | `canvas_nodes` | 023_v2_learning_canvas | ✅ |
| 17 | `canvas_objects` | 035_v2_canvas_objects | — |
| 18 | `canvas_page_collections` | 035_v2_canvas_objects | — |
| 19 | `canvas_placements` | 035_v2_canvas_objects | — |
| 20 | `canvas_viewport_states` | 023_v2_learning_canvas | ✅ |
| 21 | `card_decks` | `schema.sql`（基线） | ✅ |
| 22 | `card_sections` | `schema.sql`（基线） | ✅ |
| 23 | `card_tags` | `schema.sql`（基线） | ✅ |
| 24 | `cards` | `schema.sql`（基线） | ✅ |
| 25 | `conflict_review_items` | 018_v2_reconciliation_safety | ✅ |
| 26 | `content_group_folder_placements` | 032_v2_group_folders | ✅ |
| 27 | `content_group_members` | 033_v2_content_group_members | ✅ |
| 28 | `content_groups` | 031_v2_content_groups | ✅ |
| 29 | `content_mounts` | 035_v2_canvas_objects | — |
| 30 | `courses` | `schema.sql`（基线） | ✅ |
| 31 | `daily_statuses` | `schema.sql`（基线） | ✅ |
| 32 | `database_meta` | 056_v13_coordinate_contract | — |
| 33 | `document_chunks` | `schema.sql`（基线） | ✅ |
| 34 | `documents` | `schema.sql`（基线） | ✅ |
| 35 | `events` | 054_v13_events_ledger | ✅ |
...
| 56 | `note_tags` | 064_v13_note_tags | ✅ |
| 57 | `notes` | 015_v2_note_foundation | ✅ |
| 58 | `operation_batches` | 015_v2_note_foundation | ✅ |
| 59 | `page_frame_extensions` | 035_v2_canvas_objects | — |
| 60 | `palette_colors` | 070_v14_palette_colors | — |
| 61 | `projections` | 015_v2_note_foundation | ✅ |
| 62 | `proposals` | `schema.sql`（基线） | ✅ |
| 63 | `purpose_members` | 044_v2_purposes | — |
| 64 | `purposes` | 044_v2_purposes | — |
| 65 | `reconciliation_recovery_events` | 018_v2_reconciliation_safety | ✅ |
| 66 | `recurring_task_groups` | `schema.sql`（基线） | ✅ |
| 67 | `relation_assessments` | 047_v2_item_relation_floor | ✅ |
| 68 | `relations` | 047_v2_item_relation_floor | ✅ |
| 69 | `skin_suites` | 071_v14_skin_suites | — |
...
| 76 | `source_imprints` | 049_v2_source_imprints | — |
| 77 | `source_materializations` | 045_v2_source_identity_floor | — |
| 78 | `source_materials` | 016_v2_material_proposal | ✅ |
| 79 | `source_project_placements` | 045_v2_source_identity_floor | — |
| 80 | `source_records` | 045_v2_source_identity_floor | — |
| 81 | `source_reprojection_receipts` | 069_v13_source_reprojection_receipts | — |
| 82 | `source_scopes` | 021_v2_source_scopes | ✅ |
| 83 | `source_snapshot_pages` | 019_v2_source_snapshots | ✅ |
| 84 | `source_snapshots` | 019_v2_source_snapshots | ✅ |
| 85 | `structured_object_extensions` | 042_v2_structured_object_extensions | — |
| 86 | `study_activity_log` | `schema.sql`（基线） | ✅ |
| 87 | `study_mode_templates` | `schema.sql`（基线） | ✅ |
| 88 | `tag_groups` | `schema.sql`（基线） | ✅ |
| 89 | `tags` | `schema.sql`（基线） | ✅ |
| 90 | `task_cards` | 011_task_cards | — |
| 91 | `tasks` | `schema.sql`（基线） | ✅ |
| 92 | `template_definitions` | 025_v2_template_definitions | ✅ |
| 93 | `time_block_template_sets` | 012_time_block_templates | — |
| 94 | `time_block_templates` | 012_time_block_templates | — |
| 95 | `time_blocks` | 007_time_blocks | — |
| 96 | `users` | `schema.sql`（基线） | ✅ |
| 97 | `visual_connector_extensions` | 040_v2_visual_connector_extensions | — |
