// Reproducible synthetic Chrome/CDP component test. Requires serve.mjs on 5197.
...
const port = 9372 + presets.indexOf(preset);
const profile = resolve(root, '.codex-tmp/b1b-e1-synthetic-chrome-' + preset);
...
try {
  ...
  await send('Page.navigate',{url:'http://127.0.0.1:5197/?preset=' + preset});
