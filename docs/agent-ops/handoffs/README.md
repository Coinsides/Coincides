...
> ⚠️ **待 Henry 追认**(2026-08-23):本条由 Fable 授权、Opus 执笔。**Henry 当日裁定:`adjudication-discipline.md` 属裁定方自律卡,Fable 可改;而本文件是三方协作协议(约束 Codex 与 Claude,不只裁定方),此类改动须 Henry 本人过目后才算数。** 在他逐条过目前,本条**记录在案但不作为可执行依据**。
