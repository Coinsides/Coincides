...
| JSON 索引 | 收据 / 事件 | 卷 | 谓词 | 方向 | MinerU 原始角色→规范角色 / 序号 / 页 | Docling 原始角色→规范角色 / 序号 / 页 | 配对证明来源 |
|---:|---|---|---|---|---|---|---|
| 0 | `E-000001 / EV-000002` | academic-reading | P-STRUCT | 仅 Docling 有 | `原始[—]→规范[—];序号[—];页[—]` | `原始[picture]→规范[visual];序号[0];页[1]` | `C4_unpaired_single_side` |
| 1 | `E-000002 / EV-000005` | academic-reading | P-STRUCT | 仅 Docling 有 | `原始[—]→规范[—];序号[—];页[—]` | `原始[picture]→规范[visual];序号[4];页[1]` | `C4_unpaired_single_side` |
| 2 | `E-000003 / EV-000006` | academic-reading | P-STRUCT | 仅 Docling 有 | `原始[—]→规范[—];序号[—];页[—]` | `原始[picture]→规范[visual];序号[5];页[1]` | `C4_unpaired_single_side` |
| 3 | `E-000004 / EV-000007` | academic-reading | P-TEXT | 仅 Docling 有 | `原始[—]→规范[—];序号[—];页[—]` | `原始[text]→规范[text];序号[6];页[1]` | `SequenceMatcher_unilateral_fragment` |
| 4 | `E-000005 / EV-000008` | academic-reading | P-STRUCT | 仅 Docling 有 | `原始[—]→规范[—];序号[—];页[—]` | `原始[picture]→规范[visual];序号[7];页[1]` | `C4_unpaired_single_side` |
| 5 | `E-000006 / EV-000009` | academic-reading | P-STRUCT | 仅 Docling 有 | `原始[—]→规范[—];序号[—];页[—]` | `原始[picture]→规范[visual];序号[8];页[1]` | `C4_unpaired_single_side` |
| 6 | `E-000007 / EV-000011` | academic-reading | P-TEXT | 仅 MinerU 有 | `原始[index]→规范[index];序号[4];页[2]` | `原始[—]→规范[—];序号[—];页[—]` | `SequenceMatcher_unilateral_fragment` |
| 7 | `E-000008 / EV-000012` | academic-reading | P-NULL | 仅 Docling 有 | `原始[—]→规范[—];序号[—];页[—]` | `原始[document_index]→规范[index];序号[10];页[2]` | `P-NULL_single_side_component` |
| 8 | `E-000009 / EV-000017` | academic-reading | P-STRUCT | 仅 Docling 有 | `原始[—]→规范[—];序号[—];页[—]` | `原始[picture]→规范[visual];序号[15];页[3]` | `C4_unpaired_single_side` |
| 9 | `E-000010 / EV-000028` | academic-reading | P-STRUCT | 仅 Docling 有 | `原始[—]→规范[—];序号[—];页[—]` | `原始[table]→规范[table];序号[25];页[4]` | `C4_unpaired_single_side` |
| 10 | `E-000011 / EV-000029` | academic-reading | P-STRUCT | 仅 Docling 有 | `原始[—]→规范[—];序号[—];页[—]` | `原始[picture]→规范[visual];序号[28];页[4]` | `C4_unpaired_single_side` |
| 11 | `E-000012 / EV-000031` | academic-reading | P-TEXT | 仅 Docling 有 | `原始[—]→规范[—];序号[—];页[—]` | `原始[text]→规范[text];序号[30];页[5]` | `SequenceMatcher_unilateral_fragment` |
| 12 | `E-000013 / EV-000032` | academic-reading | P-TEXT | 仅 Docling 有 | `原始[—]→规范[—];序号[—];页[—]` | `原始[text]→规范[text];序号[31];页[5]` | `SequenceMatcher_unilateral_fragment` |
| 13 | `E-000014 / EV-000033` | academic-reading | P-TEXT | 仅 Docling 有 | `原始[—]→规范[—];序号[—];页[—]` | `原始[text]→规范[text];序号[32];页[5]` | `SequenceMatcher_unilateral_fragment` |
| 14 | `E-000015 / EV-000034` | academic-reading | P-TEXT | 仅 Docling 有 | `原始[—]→规范[—];序号[—];页[—]` | `原始[text]→规范[text];序号[33];页[5]` | `SequenceMatcher_unilateral_fragment` |
| 15 | `E-000016 / EV-000035` | academic-reading | P-TEXT | 仅 Docling 有 | `原始[—]→规范[—];序号[—];页[—]` | `原始[text]→规范[text];序号[34];页[5]` | `SequenceMatcher_unilateral_fragment` |
| 16 | `E-000017 / EV-000036` | academic-reading | P-TEXT | 仅 Docling 有 | `原始[—]→规范[—];序号[—];页[—]` | `原始[text]→规范[text];序号[35];页[5]` | `SequenceMatcher_unilateral_fragment` |
| 17 | `E-000018 / EV-000037` | academic-reading | P-TEXT | 仅 Docling 有 | `原始[—]→规范[—];序号[—];页[—]` | `原始[text]→规范[text];序号[36];页[5]` | `SequenceMatcher_unilateral_fragment` |
| 18 | `E-000019 / EV-000038` | academic-reading | P-TEXT | 仅 Docling 有 | `原始[—]→规范[—];序号[—];页[—]` | `原始[text]→规范[text];序号[37];页[5]` | `SequenceMatcher_unilateral_fragment` |
| 19 | `E-000020 / EV-000039` | academic-reading | P-STRUCT | 仅 Docling 有 | `原始[—]→规范[—];序号[—];页[—]` | `原始[picture]→规范[visual];序号[38];页[5]` | `C4_unpaired_single_side` |
| 20 | `E-000021 / EV-000060` | academic-reading | P-STRUCT | 仅 Docling 有 | `原始[—]→规范[—];序号[—];页[—]` | `原始[picture]→规范[visual];序号[61];页[8]` | `C4_unpaired_single_side` |
| 21 | `E-000022 / EV-000073` | academic-reading | P-STRUCT | 仅 Docling 有 | `原始[—]→规范[—];序号[—];页[—]` | `原始[picture]→规范[visual];序号[74];页[10]` | `C4_unpaired_single_side` |
| 22 | `E-000023 / EV-000078` | academic-reading | P-STRUCT | 仅 Docling 有 | `原始[—]→规范[—];序号[—];页[—]` | `原始[picture]→规范[visual];序号[79];页[11]` | `C4_unpaired_single_side` |
| 23 | `E-000024 / EV-000089` | academic-reading | P-STRUCT | 仅 MinerU 有 | `原始[table]→规范[table];序号[72];页[13]` | `原始[—]→规范[—];序号[—];页[—]` | `C4_unpaired_single_side` |
| 24 | `E-000025 / EV-000093` | academic-reading | P-TEXT | 仅 Docling 有 | `原始[—]→规范[—];序号[—];页[—]` | `原始[text]→规范[text];序号[90];页[13]` | `SequenceMatcher_unilateral_fragment` |
| 25 | `E-000026 / EV-000094` | academic-reading | P-TEXT | 仅 Docling 有 | `原始[—]→规范[—];序号[—];页[—]` | `原始[text]→规范[text];序号[91];页[13]` | `SequenceMatcher_unilateral_fragment` |
| 26 | `E-000027 / EV-000095` | academic-reading | P-TEXT | 仅 Docling 有 | `原始[—]→规范[—];序号[—];页[—]` | `原始[text]→规范[text];序号[92];页[13]` | `SequenceMatcher_unilateral_fragment` |
| 27 | `E-000028 / EV-000096` | academic-reading | P-TEXT | 仅 Docling 有 | `原始[—]→规范[—];序号[—];页[—]` | `原始[text]→规范[text];序号[93];页[13]` | `SequenceMatcher_unilateral_fragment` |
| 28 | `E-000029 / EV-000097` | academic-reading | P-TEXT | 仅 Docling 有 | `原始[—]→规范[—];序号[—];页[—]` | `原始[text]→规范[text];序号[94];页[13]` | `SequenceMatcher_unilateral_fragment` |
| 29 | `E-000030 / EV-000098` | academic-reading | P-TEXT | 仅 Docling 有 | `原始[—]→规范[—];序号[—];页[—]` | `原始[text]→规范[text];序号[95];页[13]` | `SequenceMatcher_unilateral_fragment` |
| 30 | `E-000031 / EV-000099` | academic-reading | P-STRUCT | 仅 Docling 有 | `原始[—]→规范[—];序号[—];页[—]` | `原始[picture]→规范[visual];序号[99];页[13]` | `C4_unpaired_single_side` |
| 31 | `E-000032 / EV-000104` | academic-reading | P-STRUCT | 仅 Docling 有 | `原始[—]→规范[—];序号[—];页[—]` | `原始[picture]→规范[visual];序号[104];页[14]` | `C4_unpaired_single_side` |
| 32 | `E-000033 / EV-000122` | academic-reading | P-STRUCT | 仅 MinerU 有 | `原始[table]→规范[table];序号[97];页[15]` | `原始[—]→规范[—];序号[—];页[—]` | `C4_unpaired_single_side` |
| 33 | `E-000034 / EV-000131` | academic-reading | P-TEXT | 仅 MinerU 有 | `原始[text]→规范[text];序号[109];页[18]` | `原始[—]→规范[—];序号[—];页[—]` | `SequenceMatcher_unilateral_fragment` |
| 34 | `E-000035 / EV-000132` | academic-reading | P-TEXT | 仅 MinerU 有 | `原始[text]→规范[text];序号[110];页[18]` | `原始[—]→规范[—];序号[—];页[—]` | `SequenceMatcher_unilateral_fragment` |
| 35 | `E-000036 / EV-000133` | academic-reading | P-TEXT | 仅 MinerU 有 | `原始[text]→规范[text];序号[111];页[18]` | `原始[—]→规范[—];序号[—];页[—]` | `SequenceMatcher_unilateral_fragment` |
| 36 | `E-000037 / EV-000134` | academic-reading | P-TEXT | 仅 MinerU 有 | `原始[text]→规范[text];序号[112];页[18]` | `原始[—]→规范[—];序号[—];页[—]` | `SequenceMatcher_unilateral_fragment` |
| 37 | `E-000038 / EV-000135` | academic-reading | P-STRUCT | 仅 Docling 有 | `原始[—]→规范[—];序号[—];页[—]` | `原始[table]→规范[table];序号[137];页[18]` | `C4_unpaired_single_side` |
| 38 | `E-000039 / EV-000136` | academic-reading | P-STRUCT | 仅 Docling 有 | `原始[—]→规范[—];序号[—];页[—]` | `原始[picture]→规范[visual];序号[138];页[18]` | `C4_unpaired_single_side` |
| 39 | `E-000040 / EV-000147` | academic-reading | P-STRUCT | 仅 Docling 有 | `原始[—]→规范[—];序号[—];页[—]` | `原始[picture]→规范[visual];序号[149];页[20]` | `C4_unpaired_single_side` |
| 40 | `E-000041 / EV-000205` | academic-reading | P-TEXT | 仅 MinerU 有 | `原始[title]→规范[heading];序号[181];页[28]` | `原始[—]→规范[—];序号[—];页[—]` | `SequenceMatcher_unilateral_fragment` |
| 41 | `E-000042 / EV-000261` | academic-reading | P-STRUCT | 仅 Docling 有 | `原始[—]→规范[—];序号[—];页[—]` | `原始[picture]→规范[visual];序号[262];页[33]` | `C4_unpaired_single_side` |
| 42 | `E-000043 / EV-000286` | academic-reading | P-STRUCT | 仅 Docling 有 | `原始[—]→规范[—];序号[—];页[—]` | `原始[picture]→规范[visual];序号[287];页[37]` | `C4_unpaired_single_side` |
| 43 | `E-000044 / EV-000310` | academic-reading | P-STRUCT | 仅 Docling 有 | `原始[—]→规范[—];序号[—];页[—]` | `原始[picture]→规范[visual];序号[311];页[40]` | `C4_unpaired_single_side` |
| 44 | `E-000045 / EV-000340` | academic-reading | P-TEXT | 仅 Docling 有 | `原始[—]→规范[—];序号[—];页[—]` | `原始[text]→规范[text];序号[338];页[45]` | `SequenceMatcher_unilateral_fragment` |
| 45 | `E-000046 / EV-000341` | academic-reading | P-TEXT | 仅 Docling 有 | `原始[—]→规范[—];序号[—];页[—]` | `原始[section_header]→规范[heading];序号[341];页[45]` | `SequenceMatcher_unilateral_fragment` |
| 46 | `E-000047 / EV-000342` | academic-reading | P-STRUCT | 仅 Docling 有 | `原始[—]→规范[—];序号[—];页[—]` | `原始[picture]→规范[visual];序号[343];页[45]` | `C4_unpaired_single_side` |
| 47 | `E-000048 / EV-000349` | academic-reading | P-STRUCT | 仅 Docling 有 | `原始[—]→规范[—];序号[—];页[—]` | `原始[picture]→规范[visual];序号[350];页[46]` | `C4_unpaired_single_side` |
| 48 | `E-000049 / EV-000351` | writing-example-responses | P-STRUCT | 仅 Docling 有 | `原始[—]→规范[—];序号[—];页[—]` | `原始[picture]→规范[visual];序号[0];页[1]` | `C4_unpaired_single_side` |
| 49 | `E-000050 / EV-000353` | writing-example-responses | P-TEXT | 仅 Docling 有 | `原始[—]→规范[—];序号[—];页[—]` | `原始[text]→规范[text];序号[1];页[1]` | `SequenceMatcher_unilateral_fragment` |
| 50 | `E-000051 / EV-000373` | writing-example-responses | P-NULL | 仅 MinerU 有 | `原始[text]→规范[text];序号[21];页[1]` | `原始[—]→规范[—];序号[—];页[—]` | `P-NULL_single_side_component` |
| 51 | `E-000052 / EV-000403` | writing-example-responses | P-STRUCT | 仅 Docling 有 | `原始[—]→规范[—];序号[—];页[—]` | `原始[table]→规范[table];序号[53];页[4]` | `C4_unpaired_single_side` |
| 52 | `E-000053 / EV-000405` | academic-writing | P-STRUCT | 仅 Docling 有 | `原始[—]→规范[—];序号[—];页[—]` | `原始[picture]→规范[visual];序号[0];页[1]` | `C4_unpaired_single_side` |
| 53 | `E-000054 / EV-000410` | academic-writing | P-STRUCT | 仅 Docling 有 | `原始[—]→规范[—];序号[—];页[—]` | `原始[picture]→规范[visual];序号[6];页[1]` | `C4_unpaired_single_side` |
| 54 | `E-000055 / EV-000411` | academic-writing | P-STRUCT | 仅 Docling 有 | `原始[—]→规范[—];序号[—];页[—]` | `原始[picture]→规范[visual];序号[7];页[1]` | `C4_unpaired_single_side` |
| 55 | `E-000056 / EV-000412` | academic-writing | P-TEXT | 仅 Docling 有 | `原始[—]→规范[—];序号[—];页[—]` | `原始[text]→规范[text];序号[8];页[1]` | `SequenceMatcher_unilateral_fragment` |
| 56 | `E-000057 / EV-000413` | academic-writing | P-STRUCT | 仅 Docling 有 | `原始[—]→规范[—];序号[—];页[—]` | `原始[picture]→规范[visual];序号[9];页[1]` | `C4_unpaired_single_side` |
| 57 | `E-000058 / EV-000415` | academic-writing | P-TEXT | 仅 MinerU 有 | `原始[index]→规范[index];序号[6];页[2]` | `原始[—]→规范[—];序号[—];页[—]` | `SequenceMatcher_unilateral_fragment` |
| 58 | `E-000059 / EV-000416` | academic-writing | P-NULL | 仅 Docling 有 | `原始[—]→规范[—];序号[—];页[—]` | `原始[document_index]→规范[index];序号[11];页[2]` | `P-NULL_single_side_component` |
| 59 | `E-000060 / EV-000431` | academic-writing | P-TEXT | 仅 Docling 有 | `原始[—]→规范[—];序号[—];页[—]` | `原始[section_header]→规范[heading];序号[25];页[4]` | `SequenceMatcher_unilateral_fragment` |
| 60 | `E-000061 / EV-000489` | academic-writing | P-TEXT | 仅 MinerU 有 | `原始[text]→规范[text];序号[78];页[9]` | `原始[—]→规范[—];序号[—];页[—]` | `SequenceMatcher_unilateral_fragment` |
| 61 | `E-000062 / EV-000493` | academic-writing | P-STRUCT | 仅 Docling 有 | `原始[—]→规范[—];序号[—];页[—]` | `原始[picture]→规范[visual];序号[84];页[9]` | `C4_unpaired_single_side` |
| 62 | `E-000063 / EV-000495` | academic-writing | P-TEXT | 仅 MinerU 有 | `原始[list]→规范[list];序号[83];页[10]` | `原始[—]→规范[—];序号[—];页[—]` | `SequenceMatcher_unilateral_fragment` |
| 63 | `E-000064 / EV-000499` | academic-writing | P-STRUCT | 仅 Docling 有 | `原始[—]→规范[—];序号[—];页[—]` | `原始[picture]→规范[visual];序号[89];页[10]` | `C4_unpaired_single_side` |
| 64 | `E-000065 / EV-000501` | academic-writing | P-TEXT | 仅 MinerU 有 | `原始[text]→规范[text];序号[88];页[11]` | `原始[—]→规范[—];序号[—];页[—]` | `SequenceMatcher_unilateral_fragment` |
| 65 | `E-000066 / EV-000505` | academic-writing | P-STRUCT | 仅 Docling 有 | `原始[—]→规范[—];序号[—];页[—]` | `原始[picture]→规范[visual];序号[94];页[11]` | `C4_unpaired_single_side` |
| 66 | `E-000067 / EV-000507` | academic-writing | P-TEXT | 仅 MinerU 有 | `原始[text]→规范[text];序号[93];页[12]` | `原始[—]→规范[—];序号[—];页[—]` | `SequenceMatcher_unilateral_fragment` |
| 67 | `E-000068 / EV-000511` | academic-writing | P-STRUCT | 仅 Docling 有 | `原始[—]→规范[—];序号[—];页[—]` | `原始[picture]→规范[visual];序号[99];页[12]` | `C4_unpaired_single_side` |
| 68 | `E-000069 / EV-000513` | academic-writing | P-TEXT | 仅 MinerU 有 | `原始[text]→规范[text];序号[98];页[13]` | `原始[—]→规范[—];序号[—];页[—]` | `SequenceMatcher_unilateral_fragment` |
| 69 | `E-000070 / EV-000514` | academic-writing | P-TEXT | 仅 MinerU 有 | `原始[text]→规范[text];序号[99];页[13]` | `原始[—]→规范[—];序号[—];页[—]` | `SequenceMatcher_unilateral_fragment` |
| 70 | `E-000071 / EV-000518` | academic-writing | P-STRUCT | 仅 Docling 有 | `原始[—]→规范[—];序号[—];页[—]` | `原始[picture]→规范[visual];序号[104];页[13]` | `C4_unpaired_single_side` |
| 71 | `E-000072 / EV-000524` | academic-writing | P-STRUCT | 仅 Docling 有 | `原始[—]→规范[—];序号[—];页[—]` | `原始[picture]→规范[visual];序号[113];页[15]` | `C4_unpaired_single_side` |
| 72 | `E-000073 / EV-000526` | academic-writing | P-STRUCT | 仅 Docling 有 | `原始[—]→规范[—];序号[—];页[—]` | `原始[picture]→规范[visual];序号[116];页[16]` | `C4_unpaired_single_side` |
| 73 | `E-000074 / EV-000530` | academic-writing | P-STRUCT | 仅 Docling 有 | `原始[—]→规范[—];序号[—];页[—]` | `原始[picture]→规范[visual];序号[120];页[17]` | `C4_unpaired_single_side` |
| 74 | `E-000075 / EV-000537` | academic-writing | P-NULL | 仅 MinerU 有 | `原始[text]→规范[text];序号[123];页[20]` | `原始[—]→规范[—];序号[—];页[—]` | `P-NULL_single_side_component` |
| 75 | `E-000076 / EV-000545` | academic-writing | P-STRUCT | 仅 Docling 有 | `原始[—]→规范[—];序号[—];页[—]` | `原始[picture]→规范[visual];序号[140];页[23]` | `C4_unpaired_single_side` |
| 76 | `E-000077 / EV-000549` | academic-writing | P-STRUCT | 仅 Docling 有 | `原始[—]→规范[—];序号[—];页[—]` | `原始[picture]→规范[visual];序号[144];页[24]` | `C4_unpaired_single_side` |
| 77 | `E-000078 / EV-000554` | academic-writing | P-STRUCT | 仅 Docling 有 | `原始[—]→规范[—];序号[—];页[—]` | `原始[picture]→规范[visual];序号[150];页[26]` | `C4_unpaired_single_side` |
| 78 | `E-000079 / EV-000557` | listening | P-STRUCT | 仅 Docling 有 | `原始[—]→规范[—];序号[—];页[—]` | `原始[picture]→规范[visual];序号[0];页[1]` | `C4_unpaired_single_side` |
| 79 | `E-000080 / EV-000559` | listening | P-TEXT | 仅 Docling 有 | `原始[—]→规范[—];序号[—];页[—]` | `原始[text]→规范[text];序号[1];页[1]` | `SequenceMatcher_unilateral_fragment` |
| 80 | `E-000081 / EV-000561` | listening | P-STRUCT | 仅 Docling 有 | `原始[—]→规范[—];序号[—];页[—]` | `原始[picture]→规范[visual];序号[5];页[1]` | `C4_unpaired_single_side` |
| 81 | `E-000082 / EV-000562` | listening | P-STRUCT | 仅 Docling 有 | `原始[—]→规范[—];序号[—];页[—]` | `原始[picture]→规范[visual];序号[6];页[1]` | `C4_unpaired_single_side` |
| 82 | `E-000083 / EV-000563` | listening | P-TEXT | 仅 Docling 有 | `原始[—]→规范[—];序号[—];页[—]` | `原始[text]→规范[text];序号[7];页[1]` | `SequenceMatcher_unilateral_fragment` |
| 83 | `E-000084 / EV-000564` | listening | P-STRUCT | 仅 Docling 有 | `原始[—]→规范[—];序号[—];页[—]` | `原始[picture]→规范[visual];序号[8];页[1]` | `C4_unpaired_single_side` |
| 84 | `E-000085 / EV-000565` | listening | P-STRUCT | 仅 Docling 有 | `原始[—]→规范[—];序号[—];页[—]` | `原始[picture]→规范[visual];序号[9];页[1]` | `C4_unpaired_single_side` |
| 85 | `E-000086 / EV-000567` | listening | P-TEXT | 仅 MinerU 有 | `原始[index]→规范[index];序号[4];页[2]` | `原始[—]→规范[—];序号[—];页[—]` | `SequenceMatcher_unilateral_fragment` |
| 86 | `E-000087 / EV-000568` | listening | P-NULL | 仅 Docling 有 | `原始[—]→规范[—];序号[—];页[—]` | `原始[document_index]→规范[index];序号[11];页[2]` | `P-NULL_single_side_component` |
| 87 | `E-000088 / EV-000574` | listening | P-TEXT | 仅 MinerU 有 | `原始[title]→规范[heading];序号[10];页[3]` | `原始[—]→规范[—];序号[—];页[—]` | `SequenceMatcher_unilateral_fragment` |
| 88 | `E-000089 / EV-000575` | listening | P-TEXT | 仅 MinerU 有 | `原始[text]→规范[text];序号[11];页[3]` | `原始[—]→规范[—];序号[—];页[—]` | `SequenceMatcher_unilateral_fragment` |
| 89 | `E-000090 / EV-000576` | listening | P-TEXT | 仅 MinerU 有 | `原始[text]→规范[text];序号[12];页[3]` | `原始[—]→规范[—];序号[—];页[—]` | `SequenceMatcher_unilateral_fragment` |
| 90 | `E-000091 / EV-000577` | listening | P-TEXT | 仅 MinerU 有 | `原始[text]→规范[text];序号[13];页[3]` | `原始[—]→规范[—];序号[—];页[—]` | `SequenceMatcher_unilateral_fragment` |
| 91 | `E-000092 / EV-000578` | listening | P-TEXT | 仅 MinerU 有 | `原始[text]→规范[text];序号[14];页[3]` | `原始[—]→规范[—];序号[—];页[—]` | `SequenceMatcher_unilateral_fragment` |
| 92 | `E-000093 / EV-000579` | listening | P-TEXT | 仅 MinerU 有 | `原始[text]→规范[text];序号[15];页[3]` | `原始[—]→规范[—];序号[—];页[—]` | `SequenceMatcher_unilateral_fragment` |
| 93 | `E-000094 / EV-000580` | listening | P-TEXT | 仅 MinerU 有 | `原始[text]→规范[text];序号[16];页[3]` | `原始[—]→规范[—];序号[—];页[—]` | `SequenceMatcher_unilateral_fragment` |
| 94 | `E-000095 / EV-000581` | listening | P-TEXT | 仅 MinerU 有 | `原始[text]→规范[text];序号[17];页[3]` | `原始[—]→规范[—];序号[—];页[—]` | `SequenceMatcher_unilateral_fragment` |
| 95 | `E-000096 / EV-000583` | listening | P-TEXT | 仅 MinerU 有 | `原始[text]→规范[text];序号[18];页[3]` | `原始[—]→规范[—];序号[—];页[—]` | `SequenceMatcher_unilateral_fragment` |
| 96 | `E-000097 / EV-000584` | listening | P-TEXT | 仅 MinerU 有 | `原始[text]→规范[text];序号[19];页[3]` | `原始[—]→规范[—];序号[—];页[—]` | `SequenceMatcher_unilateral_fragment` |
| 97 | `E-000098 / EV-000585` | listening | P-TEXT | 仅 MinerU 有 | `原始[text]→规范[text];序号[20];页[3]` | `原始[—]→规范[—];序号[—];页[—]` | `SequenceMatcher_unilateral_fragment` |
| 98 | `E-000099 / EV-000586` | listening | P-TEXT | 仅 MinerU 有 | `原始[text]→规范[text];序号[22];页[3]` | `原始[—]→规范[—];序号[—];页[—]` | `SequenceMatcher_unilateral_fragment` |
| 99 | `E-000100 / EV-000587` | listening | P-TEXT | 仅 MinerU 有 | `原始[text]→规范[text];序号[23];页[3]` | `原始[—]→规范[—];序号[—];页[—]` | `SequenceMatcher_unilateral_fragment` |
| 100 | `E-000101 / EV-000588` | listening | P-TEXT | 仅 MinerU 有 | `原始[text]→规范[text];序号[24];页[3]` | `原始[—]→规范[—];序号[—];页[—]` | `SequenceMatcher_unilateral_fragment` |
| 101 | `E-000102 / EV-000589` | listening | P-TEXT | 仅 MinerU 有 | `原始[text]→规范[text];序号[25];页[3]` | `原始[—]→规范[—];序号[—];页[—]` | `SequenceMatcher_unilateral_fragment` |
| 102 | `E-000103 / EV-000590` | listening | P-TEXT | 仅 MinerU 有 | `原始[text]→规范[text];序号[26];页[3]` | `原始[—]→规范[—];序号[—];页[—]` | `SequenceMatcher_unilateral_fragment` |
| 103 | `E-000104 / EV-000642` | listening | P-STRUCT | 仅 Docling 有 | `原始[—]→规范[—];序号[—];页[—]` | `原始[table]→规范[table];序号[76];页[8]` | `C4_unpaired_single_side` |
| 104 | `E-000105 / EV-000643` | listening | P-TEXT | 仅 MinerU 有 | `原始[text]→规范[text];序号[77];页[8]` | `原始[—]→规范[—];序号[—];页[—]` | `SequenceMatcher_unilateral_fragment` |
| 105 | `E-000106 / EV-000645` | listening | P-TEXT | 仅 MinerU 有 | `原始[text]→规范[text];序号[78];页[8]` | `原始[—]→规范[—];序号[—];页[—]` | `SequenceMatcher_unilateral_fragment` |
| 106 | `E-000107 / EV-000646` | listening | P-TEXT | 仅 MinerU 有 | `原始[text]→规范[text];序号[79];页[8]` | `原始[—]→规范[—];序号[—];页[—]` | `SequenceMatcher_unilateral_fragment` |
| 107 | `E-000108 / EV-000647` | listening | P-STRUCT | 仅 Docling 有 | `原始[—]→规范[—];序号[—];页[—]` | `原始[picture]→规范[visual];序号[83];页[8]` | `C4_unpaired_single_side` |
| 108 | `E-000109 / EV-000668` | listening | P-NULL | 仅 MinerU 有 | `原始[text]→规范[text];序号[104];页[11]` | `原始[—]→规范[—];序号[—];页[—]` | `P-NULL_single_side_component` |
| 109 | `E-000110 / EV-000671` | listening | P-TEXT | 仅 Docling 有 | `原始[—]→规范[—];序号[—];页[—]` | `原始[list_item]→规范[list];序号[106];页[11]` | `SequenceMatcher_unilateral_fragment` |
| 110 | `E-000111 / EV-000676` | listening | P-NULL | 仅 MinerU 有 | `原始[text]→规范[text];序号[111];页[11]` | `原始[—]→规范[—];序号[—];页[—]` | `P-NULL_single_side_component` |
| 111 | `E-000112 / EV-000677` | listening | P-TEXT | 仅 Docling 有 | `原始[—]→规范[—];序号[—];页[—]` | `原始[list_item]→规范[list];序号[113];页[11]` | `SequenceMatcher_unilateral_fragment` |
| 112 | `E-000113 / EV-000692` | listening | P-NULL | 仅 Docling 有 | `原始[—]→规范[—];序号[—];页[—]` | `原始[text]→规范[text];序号[134];页[14]` | `P-NULL_single_side_component` |
| 113 | `E-000114 / EV-000693` | listening | P-NULL | 仅 Docling 有 | `原始[—]→规范[—];序号[—];页[—]` | `原始[text]→规范[text];序号[137];页[14]` | `P-NULL_single_side_component` |
| 114 | `E-000115 / EV-000694` | listening | P-NULL | 仅 Docling 有 | `原始[—]→规范[—];序号[—];页[—]` | `原始[text]→规范[text];序号[139];页[14]` | `P-NULL_single_side_component` |
| 115 | `E-000116 / EV-000710` | listening | P-STRUCT | 仅 Docling 有 | `原始[—]→规范[—];序号[—];页[—]` | `原始[picture]→规范[visual];序号[155];页[16]` | `C4_unpaired_single_side` |
| 116 | `E-000117 / EV-000716` | listening | P-STRUCT | 仅 Docling 有 | `原始[—]→规范[—];序号[—];页[—]` | `原始[picture]→规范[visual];序号[161];页[17]` | `C4_unpaired_single_side` |
| 117 | `E-000118 / EV-000735` | listening | P-TEXT | 仅 MinerU 有 | `原始[text]→规范[text];序号[164];页[19]` | `原始[—]→规范[—];序号[—];页[—]` | `SequenceMatcher_unilateral_fragment` |
| 118 | `E-000119 / EV-000736` | listening | P-TEXT | 仅 MinerU 有 | `原始[text]→规范[text];序号[165];页[19]` | `原始[—]→规范[—];序号[—];页[—]` | `SequenceMatcher_unilateral_fragment` |
| 119 | `E-000120 / EV-000737` | listening | P-TEXT | 仅 MinerU 有 | `原始[text]→规范[text];序号[166];页[19]` | `原始[—]→规范[—];序号[—];页[—]` | `SequenceMatcher_unilateral_fragment` |
| 120 | `E-000121 / EV-000738` | listening | P-TEXT | 仅 MinerU 有 | `原始[text]→规范[text];序号[167];页[19]` | `原始[—]→规范[—];序号[—];页[—]` | `SequenceMatcher_unilateral_fragment` |
| 121 | `E-000122 / EV-000739` | listening | P-TEXT | 仅 MinerU 有 | `原始[text]→规范[text];序号[168];页[19]` | `原始[—]→规范[—];序号[—];页[—]` | `SequenceMatcher_unilateral_fragment` |
| 122 | `E-000123 / EV-000740` | listening | P-TEXT | 仅 MinerU 有 | `原始[text]→规范[text];序号[169];页[19]` | `原始[—]→规范[—];序号[—];页[—]` | `SequenceMatcher_unilateral_fragment` |
| 123 | `E-000124 / EV-000741` | listening | P-TEXT | 仅 MinerU 有 | `原始[text]→规范[text];序号[170];页[19]` | `原始[—]→规范[—];序号[—];页[—]` | `SequenceMatcher_unilateral_fragment` |
| 124 | `E-000125 / EV-000742` | listening | P-TEXT | 仅 MinerU 有 | `原始[text]→规范[text];序号[171];页[19]` | `原始[—]→规范[—];序号[—];页[—]` | `SequenceMatcher_unilateral_fragment` |
| 125 | `E-000126 / EV-000743` | listening | P-TEXT | 仅 MinerU 有 | `原始[text]→规范[text];序号[172];页[19]` | `原始[—]→规范[—];序号[—];页[—]` | `SequenceMatcher_unilateral_fragment` |
| 126 | `E-000127 / EV-000744` | listening | P-TEXT | 仅 MinerU 有 | `原始[text]→规范[text];序号[173];页[19]` | `原始[—]→规范[—];序号[—];页[—]` | `SequenceMatcher_unilateral_fragment` |
| 127 | `E-000128 / EV-000745` | listening | P-STRUCT | 仅 Docling 有 | `原始[—]→规范[—];序号[—];页[—]` | `原始[table]→规范[table];序号[180];页[19]` | `C4_unpaired_single_side` |
| 128 | `E-000129 / EV-000746` | listening | P-TEXT | 仅 MinerU 有 | `原始[text]→规范[text];序号[174];页[20]` | `原始[—]→规范[—];序号[—];页[—]` | `SequenceMatcher_unilateral_fragment` |
| 129 | `E-000130 / EV-000747` | listening | P-TEXT | 仅 MinerU 有 | `原始[text]→规范[text];序号[175];页[20]` | `原始[—]→规范[—];序号[—];页[—]` | `SequenceMatcher_unilateral_fragment` |
| 130 | `E-000131 / EV-000748` | listening | P-TEXT | 仅 MinerU 有 | `原始[text]→规范[text];序号[176];页[20]` | `原始[—]→规范[—];序号[—];页[—]` | `SequenceMatcher_unilateral_fragment` |
| 131 | `E-000132 / EV-000749` | listening | P-TEXT | 仅 MinerU 有 | `原始[text]→规范[text];序号[177];页[20]` | `原始[—]→规范[—];序号[—];页[—]` | `SequenceMatcher_unilateral_fragment` |
| 132 | `E-000133 / EV-000750` | listening | P-TEXT | 仅 MinerU 有 | `原始[text]→规范[text];序号[178];页[20]` | `原始[—]→规范[—];序号[—];页[—]` | `SequenceMatcher_unilateral_fragment` |
| 133 | `E-000134 / EV-000751` | listening | P-TEXT | 仅 MinerU 有 | `原始[text]→规范[text];序号[179];页[20]` | `原始[—]→规范[—];序号[—];页[—]` | `SequenceMatcher_unilateral_fragment` |
| 134 | `E-000135 / EV-000752` | listening | P-TEXT | 仅 MinerU 有 | `原始[text]→规范[text];序号[180];页[20]` | `原始[—]→规范[—];序号[—];页[—]` | `SequenceMatcher_unilateral_fragment` |
| 135 | `E-000136 / EV-000753` | listening | P-TEXT | 仅 MinerU 有 | `原始[text]→规范[text];序号[181];页[20]` | `原始[—]→规范[—];序号[—];页[—]` | `SequenceMatcher_unilateral_fragment` |
| 136 | `E-000137 / EV-000754` | listening | P-STRUCT | 仅 Docling 有 | `原始[—]→规范[—];序号[—];页[—]` | `原始[table]→规范[table];序号[181];页[20]` | `C4_unpaired_single_side` |
| 137 | `E-000138 / EV-000755` | listening | P-TEXT | 仅 MinerU 有 | `原始[text]→规范[text];序号[182];页[20]` | `原始[—]→规范[—];序号[—];页[—]` | `SequenceMatcher_unilateral_fragment` |
| 138 | `E-000139 / EV-000756` | listening | P-TEXT | 仅 MinerU 有 | `原始[text]→规范[text];序号[183];页[20]` | `原始[—]→规范[—];序号[—];页[—]` | `SequenceMatcher_unilateral_fragment` |
| 139 | `E-000140 / EV-000757` | listening | P-TEXT | 仅 MinerU 有 | `原始[text]→规范[text];序号[184];页[20]` | `原始[—]→规范[—];序号[—];页[—]` | `SequenceMatcher_unilateral_fragment` |
| 140 | `E-000141 / EV-000759` | listening | P-TEXT | 仅 Docling 有 | `原始[—]→规范[—];序号[—];页[—]` | `原始[list_item]→规范[list];序号[183];页[21]` | `SequenceMatcher_unilateral_fragment` |
| 141 | `E-000142 / EV-000760` | listening | P-TEXT | 仅 Docling 有 | `原始[—]→规范[—];序号[—];页[—]` | `原始[list_item]→规范[list];序号[184];页[21]` | `SequenceMatcher_unilateral_fragment` |
| 142 | `E-000143 / EV-000761` | listening | P-TEXT | 仅 MinerU 有 | `原始[index]→规范[index];序号[185];页[21]` | `原始[—]→规范[—];序号[—];页[—]` | `SequenceMatcher_unilateral_fragment` |
| 143 | `E-000144 / EV-000762` | listening | P-TEXT | 仅 Docling 有 | `原始[—]→规范[—];序号[—];页[—]` | `原始[list_item]→规范[list];序号[185];页[21]` | `SequenceMatcher_unilateral_fragment` |
| 144 | `E-000145 / EV-000763` | listening | P-TEXT | 仅 Docling 有 | `原始[—]→规范[—];序号[—];页[—]` | `原始[list_item]→规范[list];序号[186];页[21]` | `SequenceMatcher_unilateral_fragment` |
| 145 | `E-000146 / EV-000764` | listening | P-TEXT | 仅 Docling 有 | `原始[—]→规范[—];序号[—];页[—]` | `原始[list_item]→规范[list];序号[187];页[21]` | `SequenceMatcher_unilateral_fragment` |
| 146 | `E-000147 / EV-000773` | listening | P-NULL | 仅 Docling 有 | `原始[—]→规范[—];序号[—];页[—]` | `原始[text]→规范[text];序号[198];页[22]` | `P-NULL_single_side_component` |
| 147 | `E-000148 / EV-000775` | listening | P-NULL | 仅 Docling 有 | `原始[—]→规范[—];序号[—];页[—]` | `原始[text]→规范[text];序号[199];页[22]` | `P-NULL_single_side_component` |
| 148 | `E-000149 / EV-000777` | listening | P-NULL | 仅 Docling 有 | `原始[—]→规范[—];序号[—];页[—]` | `原始[text]→规范[text];序号[200];页[22]` | `P-NULL_single_side_component` |
| 149 | `E-000150 / EV-000778` | listening | P-NULL | 仅 Docling 有 | `原始[—]→规范[—];序号[—];页[—]` | `原始[text]→规范[text];序号[201];页[22]` | `P-NULL_single_side_component` |
| 150 | `E-000151 / EV-000792` | listening | P-NULL | 仅 MinerU 有 | `原始[text]→规范[text];序号[214];页[24]` | `原始[—]→规范[—];序号[—];页[—]` | `P-NULL_single_side_component` |
| 151 | `E-000152 / EV-000802` | listening | P-TEXT | 仅 MinerU 有 | `原始[text]→规范[text];序号[224];页[26]` | `原始[—]→规范[—];序号[—];页[—]` | `SequenceMatcher_unilateral_fragment` |
| 152 | `E-000153 / EV-000803` | listening | P-TEXT | 仅 MinerU 有 | `原始[text]→规范[text];序号[225];页[26]` | `原始[—]→规范[—];序号[—];页[—]` | `SequenceMatcher_unilateral_fragment` |
| 153 | `E-000154 / EV-000804` | listening | P-TEXT | 仅 MinerU 有 | `原始[text]→规范[text];序号[226];页[26]` | `原始[—]→规范[—];序号[—];页[—]` | `SequenceMatcher_unilateral_fragment` |
| 154 | `E-000155 / EV-000805` | listening | P-TEXT | 仅 Docling 有 | `原始[—]→规范[—];序号[—];页[—]` | `原始[section_header]→规范[heading];序号[226];页[26]` | `SequenceMatcher_unilateral_fragment` |
| 155 | `E-000156 / EV-000806` | listening | P-TEXT | 仅 MinerU 有 | `原始[text]→规范[text];序号[227];页[26]` | `原始[—]→规范[—];序号[—];页[—]` | `SequenceMatcher_unilateral_fragment` |
| 156 | `E-000157 / EV-000807` | listening | P-TEXT | 仅 MinerU 有 | `原始[text]→规范[text];序号[228];页[26]` | `原始[—]→规范[—];序号[—];页[—]` | `SequenceMatcher_unilateral_fragment` |
| 157 | `E-000158 / EV-000808` | listening | P-TEXT | 仅 MinerU 有 | `原始[text]→规范[text];序号[229];页[26]` | `原始[—]→规范[—];序号[—];页[—]` | `SequenceMatcher_unilateral_fragment` |
| 158 | `E-000159 / EV-000809` | listening | P-TEXT | 仅 MinerU 有 | `原始[text]→规范[text];序号[230];页[26]` | `原始[—]→规范[—];序号[—];页[—]` | `SequenceMatcher_unilateral_fragment` |
| 159 | `E-000160 / EV-000810` | listening | P-TEXT | 仅 MinerU 有 | `原始[text]→规范[text];序号[231];页[26]` | `原始[—]→规范[—];序号[—];页[—]` | `SequenceMatcher_unilateral_fragment` |
| 160 | `E-000161 / EV-000811` | listening | P-TEXT | 仅 MinerU 有 | `原始[text]→规范[text];序号[232];页[26]` | `原始[—]→规范[—];序号[—];页[—]` | `SequenceMatcher_unilateral_fragment` |
| 161 | `E-000162 / EV-000812` | listening | P-STRUCT | 仅 Docling 有 | `原始[—]→规范[—];序号[—];页[—]` | `原始[picture]→规范[visual];序号[233];页[26]` | `C4_unpaired_single_side` |
| 162 | `E-000163 / EV-000819` | listening | P-TEXT | 仅 Docling 有 | `原始[—]→规范[—];序号[—];页[—]` | `原始[list_item]→规范[list];序号[240];页[28]` | `SequenceMatcher_unilateral_fragment` |
| 163 | `E-000164 / EV-000820` | listening | P-TEXT | 仅 Docling 有 | `原始[—]→规范[—];序号[—];页[—]` | `原始[list_item]→规范[list];序号[241];页[28]` | `SequenceMatcher_unilateral_fragment` |
| 164 | `E-000165 / EV-000821` | listening | P-TEXT | 仅 Docling 有 | `原始[—]→规范[—];序号[—];页[—]` | `原始[list_item]→规范[list];序号[242];页[28]` | `SequenceMatcher_unilateral_fragment` |
| 165 | `E-000166 / EV-000822` | listening | P-TEXT | 仅 Docling 有 | `原始[—]→规范[—];序号[—];页[—]` | `原始[list_item]→规范[list];序号[243];页[28]` | `SequenceMatcher_unilateral_fragment` |
| 166 | `E-000167 / EV-000823` | listening | P-TEXT | 仅 Docling 有 | `原始[—]→规范[—];序号[—];页[—]` | `原始[list_item]→规范[list];序号[244];页[28]` | `SequenceMatcher_unilateral_fragment` |
| 167 | `E-000168 / EV-000827` | listening | P-TEXT | 仅 MinerU 有 | `原始[text]→规范[text];序号[242];页[29]` | `原始[—]→规范[—];序号[—];页[—]` | `SequenceMatcher_unilateral_fragment` |
| 168 | `E-000169 / EV-000830` | listening | P-STRUCT | 仅 MinerU 有 | `原始[table]→规范[table];序号[245];页[29]` | `原始[—]→规范[—];序号[—];页[—]` | `C4_unpaired_single_side` |
| 169 | `E-000170 / EV-000832` | listening | P-NULL | 仅 Docling 有 | `原始[—]→规范[—];序号[—];页[—]` | `原始[text]→规范[text];序号[258];页[29]` | `P-NULL_single_side_component` |
| 170 | `E-000171 / EV-000833` | listening | P-NULL | 仅 Docling 有 | `原始[—]→规范[—];序号[—];页[—]` | `原始[text]→规范[text];序号[266];页[29]` | `P-NULL_single_side_component` |
| 171 | `E-000172 / EV-000834` | listening | P-NULL | 仅 Docling 有 | `原始[—]→规范[—];序号[—];页[—]` | `原始[text]→规范[text];序号[269];页[29]` | `P-NULL_single_side_component` |
| 172 | `E-000173 / EV-000835` | listening | P-NULL | 仅 Docling 有 | `原始[—]→规范[—];序号[—];页[—]` | `原始[text]→规范[text];序号[273];页[29]` | `P-NULL_single_side_component` |
| 173 | `E-000174 / EV-000849` | listening | P-NULL | 仅 MinerU 有 | `原始[text]→规范[text];序号[260];页[32]` | `原始[—]→规范[—];序号[—];页[—]` | `P-NULL_single_side_component` |
| 174 | `E-000175 / EV-000856` | listening | P-STRUCT | 仅 Docling 有 | `原始[—]→规范[—];序号[—];页[—]` | `原始[picture]→规范[visual];序号[305];页[33]` | `C4_unpaired_single_side` |

### 4.2 分类学差异 211 张

| JSON 索引 | 收据 / 事件 | 卷 | 谓词 | MinerU 原始角色→规范角色 / 序号 / 页 | Docling 原始角色→规范角色 / 序号 / 页 | 有序对轴 `MinerU-role × Docling-role` | 配对证明 |
|---:|---|---|---|---|---|---|---|
| 0 | `T-000001 / EV-000018` | academic-reading | P-TEXT | `原始[title]→规范[heading];序号[9];页[4]` | `原始[text]→规范[text];序号[16];页[4]` | `[heading] × [text]` | `SequenceMatcher_equal_position;ok=true` |
| 1 | `T-000002 / EV-000022` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[14];页[4]` | `原始[list_item]→规范[list];序号[20];页[4]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 2 | `T-000003 / EV-000023` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[15];页[4]` | `原始[list_item]→规范[list];序号[21];页[4]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 3 | `T-000004 / EV-000024` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[16];页[4]` | `原始[list_item]→规范[list];序号[22];页[4]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 4 | `T-000005 / EV-000025` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[17];页[4]` | `原始[list_item]→规范[list];序号[23];页[4]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 5 | `T-000006 / EV-000026` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[18];页[4]` | `原始[section_header]→规范[heading];序号[24];页[4]` | `[text] × [heading]` | `SequenceMatcher_equal_position;ok=true` |
| 6 | `T-000007 / EV-000054` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[40];页[8]` | `原始[list_item]→规范[list];序号[55];页[8]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 7 | `T-000008 / EV-000055` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[41];页[8]` | `原始[list_item]→规范[list];序号[56];页[8]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 8 | `T-000009 / EV-000056` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[42];页[8]` | `原始[list_item]→规范[list];序号[57];页[8]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 9 | `T-000010 / EV-000057` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[43];页[8]` | `原始[list_item]→规范[list];序号[58];页[8]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 10 | `T-000011 / EV-000058` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[44];页[8]` | `原始[list_item]→规范[list];序号[59];页[8]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 11 | `T-000012 / EV-000071` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[56];页[10]` | `原始[section_header]→规范[heading];序号[72];页[10]` | `[text] × [heading]` | `SequenceMatcher_equal_position;ok=true` |
| 12 | `T-000013 / EV-000075` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[59];页[11]` | `原始[list_item]→规范[list];序号[76];页[11]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 13 | `T-000014 / EV-000076` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[60];页[11]` | `原始[list_item]→规范[list];序号[77];页[11]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 14 | `T-000015 / EV-000077` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[61];页[11]` | `原始[list_item]→规范[list];序号[78];页[11]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 15 | `T-000016 / EV-000090` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[73];页[13]` | `原始[list_item]→规范[list];序号[96];页[13]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 16 | `T-000017 / EV-000091` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[74];页[13]` | `原始[list_item]→规范[list];序号[97];页[13]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 17 | `T-000018 / EV-000092` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[75];页[13]` | `原始[list_item]→规范[list];序号[98];页[13]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 18 | `T-000019 / EV-000101` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[77];页[14]` | `原始[list_item]→规范[list];序号[101];页[14]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 19 | `T-000020 / EV-000102` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[78];页[14]` | `原始[list_item]→规范[list];序号[102];页[14]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 20 | `T-000021 / EV-000103` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[79];页[14]` | `原始[list_item]→规范[list];序号[103];页[14]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 21 | `T-000022 / EV-000107` | academic-reading | P-TEXT | `原始[list]→规范[list];序号[82];页[15]` | `原始[text]→规范[text];序号[107];页[15]` | `[list] × [text]` | `SequenceMatcher_equal_position;ok=true` |
| 22 | `T-000023 / EV-000117` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[92];页[15]` | `原始[list_item]→规范[list];序号[117];页[15]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 23 | `T-000024 / EV-000124` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[99];页[15]` | `原始[list_item]→规范[list];序号[127];页[15]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 24 | `T-000025 / EV-000125` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[100];页[15]` | `原始[list_item]→规范[list];序号[128];页[15]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 25 | `T-000026 / EV-000140` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[116];页[19]` | `原始[section_header]→规范[heading];序号[142];页[19]` | `[text] × [heading]` | `SequenceMatcher_equal_position;ok=true` |
| 26 | `T-000027 / EV-000150` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[126];页[21]` | `原始[list_item]→规范[list];序号[152];页[21]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 27 | `T-000028 / EV-000151` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[127];页[21]` | `原始[list_item]→规范[list];序号[153];页[21]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 28 | `T-000029 / EV-000152` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[128];页[21]` | `原始[list_item]→规范[list];序号[154];页[21]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 29 | `T-000030 / EV-000153` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[129];页[21]` | `原始[list_item]→规范[list];序号[155];页[21]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 30 | `T-000031 / EV-000154` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[130];页[21]` | `原始[list_item]→规范[list];序号[156];页[21]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 31 | `T-000032 / EV-000155` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[131];页[21]` | `原始[list_item]→规范[list];序号[157];页[21]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 32 | `T-000033 / EV-000156` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[132];页[21]` | `原始[list_item]→规范[list];序号[158];页[21]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 33 | `T-000034 / EV-000157` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[133];页[21]` | `原始[list_item]→规范[list];序号[159];页[21]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 34 | `T-000035 / EV-000158` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[134];页[21]` | `原始[list_item]→规范[list];序号[160];页[21]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 35 | `T-000036 / EV-000160` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[136];页[22]` | `原始[list_item]→规范[list];序号[162];页[22]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 36 | `T-000037 / EV-000161` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[137];页[22]` | `原始[list_item]→规范[list];序号[163];页[22]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 37 | `T-000038 / EV-000162` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[138];页[22]` | `原始[list_item]→规范[list];序号[164];页[22]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 38 | `T-000039 / EV-000173` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[149];页[25]` | `原始[list_item]→规范[list];序号[175];页[25]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 39 | `T-000040 / EV-000174` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[150];页[25]` | `原始[list_item]→规范[list];序号[176];页[25]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 40 | `T-000041 / EV-000175` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[151];页[25]` | `原始[list_item]→规范[list];序号[177];页[25]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 41 | `T-000042 / EV-000176` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[152];页[25]` | `原始[list_item]→规范[list];序号[178];页[25]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 42 | `T-000043 / EV-000177` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[153];页[25]` | `原始[list_item]→规范[list];序号[179];页[25]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 43 | `T-000044 / EV-000178` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[154];页[25]` | `原始[list_item]→规范[list];序号[180];页[25]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 44 | `T-000045 / EV-000179` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[155];页[25]` | `原始[list_item]→规范[list];序号[181];页[25]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 45 | `T-000046 / EV-000185` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[161];页[25]` | `原始[list_item]→规范[list];序号[187];页[25]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 46 | `T-000047 / EV-000186` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[162];页[25]` | `原始[list_item]→规范[list];序号[188];页[25]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 47 | `T-000048 / EV-000187` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[163];页[25]` | `原始[list_item]→规范[list];序号[189];页[25]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 48 | `T-000049 / EV-000188` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[164];页[25]` | `原始[list_item]→规范[list];序号[190];页[25]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 49 | `T-000050 / EV-000189` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[165];页[25]` | `原始[list_item]→规范[list];序号[191];页[25]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 50 | `T-000051 / EV-000190` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[166];页[25]` | `原始[list_item]→规范[list];序号[192];页[25]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 51 | `T-000052 / EV-000193` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[169];页[26]` | `原始[list_item]→规范[list];序号[195];页[26]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 52 | `T-000053 / EV-000194` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[170];页[26]` | `原始[list_item]→规范[list];序号[196];页[26]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 53 | `T-000054 / EV-000196` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[172];页[26]` | `原始[list_item]→规范[list];序号[198];页[26]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 54 | `T-000055 / EV-000197` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[173];页[26]` | `原始[list_item]→规范[list];序号[199];页[26]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 55 | `T-000056 / EV-000206` | academic-reading | P-TEXT | `原始[title]→规范[heading];序号[182];页[28]` | `原始[text]→规范[text];序号[207];页[28]` | `[heading] × [text]` | `SequenceMatcher_equal_position;ok=true` |
| 56 | `T-000057 / EV-000209` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[185];页[28]` | `原始[list_item]→规范[list];序号[210];页[28]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 57 | `T-000058 / EV-000210` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[186];页[28]` | `原始[list_item]→规范[list];序号[211];页[28]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 58 | `T-000059 / EV-000211` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[187];页[28]` | `原始[list_item]→规范[list];序号[212];页[28]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 59 | `T-000060 / EV-000212` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[188];页[28]` | `原始[list_item]→规范[list];序号[213];页[28]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 60 | `T-000061 / EV-000214` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[190];页[28]` | `原始[list_item]→规范[list];序号[215];页[28]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 61 | `T-000062 / EV-000215` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[191];页[28]` | `原始[list_item]→规范[list];序号[216];页[28]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 62 | `T-000063 / EV-000216` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[192];页[28]` | `原始[list_item]→规范[list];序号[217];页[28]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 63 | `T-000064 / EV-000217` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[193];页[28]` | `原始[list_item]→规范[list];序号[218];页[28]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 64 | `T-000065 / EV-000219` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[195];页[28]` | `原始[list_item]→规范[list];序号[220];页[28]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 65 | `T-000066 / EV-000220` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[196];页[28]` | `原始[list_item]→规范[list];序号[221];页[28]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 66 | `T-000067 / EV-000221` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[197];页[28]` | `原始[list_item]→规范[list];序号[222];页[28]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 67 | `T-000068 / EV-000222` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[198];页[28]` | `原始[list_item]→规范[list];序号[223];页[28]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 68 | `T-000069 / EV-000224` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[200];页[28]` | `原始[list_item]→规范[list];序号[225];页[28]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 69 | `T-000070 / EV-000225` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[201];页[28]` | `原始[list_item]→规范[list];序号[226];页[28]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 70 | `T-000071 / EV-000226` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[202];页[28]` | `原始[list_item]→规范[list];序号[227];页[28]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 71 | `T-000072 / EV-000227` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[203];页[28]` | `原始[list_item]→规范[list];序号[228];页[28]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 72 | `T-000073 / EV-000229` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[205];页[29]` | `原始[list_item]→规范[list];序号[230];页[29]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 73 | `T-000074 / EV-000230` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[206];页[29]` | `原始[list_item]→规范[list];序号[231];页[29]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 74 | `T-000075 / EV-000231` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[207];页[29]` | `原始[list_item]→规范[list];序号[232];页[29]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 75 | `T-000076 / EV-000232` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[208];页[29]` | `原始[list_item]→规范[list];序号[233];页[29]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 76 | `T-000077 / EV-000248` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[224];页[32]` | `原始[list_item]→规范[list];序号[249];页[32]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 77 | `T-000078 / EV-000249` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[225];页[32]` | `原始[list_item]→规范[list];序号[250];页[32]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 78 | `T-000079 / EV-000250` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[226];页[32]` | `原始[list_item]→规范[list];序号[251];页[32]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 79 | `T-000080 / EV-000251` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[227];页[32]` | `原始[list_item]→规范[list];序号[252];页[32]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 80 | `T-000081 / EV-000252` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[228];页[32]` | `原始[list_item]→规范[list];序号[253];页[32]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 81 | `T-000082 / EV-000253` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[229];页[32]` | `原始[list_item]→规范[list];序号[254];页[32]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 82 | `T-000083 / EV-000255` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[231];页[33]` | `原始[list_item]→规范[list];序号[256];页[33]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 83 | `T-000084 / EV-000256` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[232];页[33]` | `原始[list_item]→规范[list];序号[257];页[33]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 84 | `T-000085 / EV-000257` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[233];页[33]` | `原始[list_item]→规范[list];序号[258];页[33]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 85 | `T-000086 / EV-000258` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[234];页[33]` | `原始[list_item]→规范[list];序号[259];页[33]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 86 | `T-000087 / EV-000259` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[235];页[33]` | `原始[list_item]→规范[list];序号[260];页[33]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 87 | `T-000088 / EV-000260` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[236];页[33]` | `原始[list_item]→规范[list];序号[261];页[33]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 88 | `T-000089 / EV-000275` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[251];页[36]` | `原始[list_item]→规范[list];序号[276];页[36]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 89 | `T-000090 / EV-000276` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[252];页[36]` | `原始[list_item]→规范[list];序号[277];页[36]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 90 | `T-000091 / EV-000277` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[253];页[36]` | `原始[list_item]→规范[list];序号[278];页[36]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 91 | `T-000092 / EV-000278` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[254];页[36]` | `原始[list_item]→规范[list];序号[279];页[36]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 92 | `T-000093 / EV-000279` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[255];页[36]` | `原始[list_item]→规范[list];序号[280];页[36]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 93 | `T-000094 / EV-000281` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[257];页[37]` | `原始[list_item]→规范[list];序号[282];页[37]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 94 | `T-000095 / EV-000282` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[258];页[37]` | `原始[list_item]→规范[list];序号[283];页[37]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 95 | `T-000096 / EV-000283` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[259];页[37]` | `原始[list_item]→规范[list];序号[284];页[37]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 96 | `T-000097 / EV-000284` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[260];页[37]` | `原始[list_item]→规范[list];序号[285];页[37]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 97 | `T-000098 / EV-000285` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[261];页[37]` | `原始[list_item]→规范[list];序号[286];页[37]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 98 | `T-000099 / EV-000298` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[273];页[39]` | `原始[list_item]→规范[list];序号[299];页[39]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 99 | `T-000100 / EV-000299` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[274];页[39]` | `原始[list_item]→规范[list];序号[300];页[39]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 100 | `T-000101 / EV-000300` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[275];页[39]` | `原始[list_item]→规范[list];序号[301];页[39]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 101 | `T-000102 / EV-000301` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[276];页[39]` | `原始[list_item]→规范[list];序号[302];页[39]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 102 | `T-000103 / EV-000302` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[277];页[39]` | `原始[list_item]→规范[list];序号[303];页[39]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 103 | `T-000104 / EV-000303` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[278];页[39]` | `原始[list_item]→规范[list];序号[304];页[39]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 104 | `T-000105 / EV-000304` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[279];页[39]` | `原始[list_item]→规范[list];序号[305];页[39]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 105 | `T-000106 / EV-000306` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[281];页[40]` | `原始[list_item]→规范[list];序号[307];页[40]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 106 | `T-000107 / EV-000307` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[282];页[40]` | `原始[list_item]→规范[list];序号[308];页[40]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 107 | `T-000108 / EV-000308` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[283];页[40]` | `原始[list_item]→规范[list];序号[309];页[40]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 108 | `T-000109 / EV-000309` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[284];页[40]` | `原始[list_item]→规范[list];序号[310];页[40]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 109 | `T-000110 / EV-000324` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[298];页[43]` | `原始[list_item]→规范[list];序号[325];页[43]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 110 | `T-000111 / EV-000325` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[299];页[43]` | `原始[list_item]→规范[list];序号[326];页[43]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 111 | `T-000112 / EV-000326` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[300];页[43]` | `原始[list_item]→规范[list];序号[327];页[43]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 112 | `T-000113 / EV-000327` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[301];页[43]` | `原始[list_item]→规范[list];序号[328];页[43]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 113 | `T-000114 / EV-000328` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[302];页[43]` | `原始[list_item]→规范[list];序号[329];页[43]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 114 | `T-000115 / EV-000344` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[315];页[46]` | `原始[list_item]→规范[list];序号[345];页[46]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 115 | `T-000116 / EV-000345` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[316];页[46]` | `原始[list_item]→规范[list];序号[346];页[46]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 116 | `T-000117 / EV-000346` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[317];页[46]` | `原始[list_item]→规范[list];序号[347];页[46]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 117 | `T-000118 / EV-000347` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[318];页[46]` | `原始[list_item]→规范[list];序号[348];页[46]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 118 | `T-000119 / EV-000348` | academic-reading | P-TEXT | `原始[text]→规范[text];序号[319];页[46]` | `原始[list_item]→规范[list];序号[349];页[46]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 119 | `T-000120 / EV-000397` | writing-example-responses | P-TEXT | `原始[list]→规范[list];序号[45];页[3]` | `原始[text]→规范[text];序号[48];页[3]` | `[list] × [text]` | `SequenceMatcher_equal_position;ok=true` |
| 120 | `T-000121 / EV-000595` | listening | P-TEXT | `原始[text]→规范[text];序号[31];页[4]` | `原始[list_item]→规范[list];序号[22];页[4]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 121 | `T-000122 / EV-000596` | listening | P-TEXT | `原始[text]→规范[text];序号[32];页[4]` | `原始[list_item]→规范[list];序号[23];页[4]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 122 | `T-000123 / EV-000597` | listening | P-TEXT | `原始[text]→规范[text];序号[33];页[4]` | `原始[list_item]→规范[list];序号[24];页[4]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 123 | `T-000124 / EV-000598` | listening | P-TEXT | `原始[text]→规范[text];序号[34];页[4]` | `原始[list_item]→规范[list];序号[25];页[4]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 124 | `T-000125 / EV-000599` | listening | P-TEXT | `原始[text]→规范[text];序号[35];页[4]` | `原始[list_item]→规范[list];序号[26];页[4]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 125 | `T-000126 / EV-000600` | listening | P-TEXT | `原始[text]→规范[text];序号[36];页[4]` | `原始[list_item]→规范[list];序号[27];页[4]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 126 | `T-000127 / EV-000601` | listening | P-TEXT | `原始[text]→规范[text];序号[37];页[4]` | `原始[list_item]→规范[list];序号[28];页[4]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 127 | `T-000128 / EV-000602` | listening | P-TEXT | `原始[text]→规范[text];序号[38];页[4]` | `原始[list_item]→规范[list];序号[29];页[4]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 128 | `T-000129 / EV-000603` | listening | P-TEXT | `原始[text]→规范[text];序号[39];页[4]` | `原始[list_item]→规范[list];序号[30];页[4]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 129 | `T-000130 / EV-000604` | listening | P-TEXT | `原始[text]→规范[text];序号[40];页[4]` | `原始[list_item]→规范[list];序号[31];页[4]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 130 | `T-000131 / EV-000605` | listening | P-TEXT | `原始[text]→规范[text];序号[41];页[4]` | `原始[list_item]→规范[list];序号[32];页[4]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 131 | `T-000132 / EV-000606` | listening | P-TEXT | `原始[text]→规范[text];序号[42];页[4]` | `原始[list_item]→规范[list];序号[33];页[4]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 132 | `T-000133 / EV-000607` | listening | P-TEXT | `原始[text]→规范[text];序号[43];页[4]` | `原始[list_item]→规范[list];序号[34];页[4]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 133 | `T-000134 / EV-000608` | listening | P-TEXT | `原始[text]→规范[text];序号[44];页[4]` | `原始[list_item]→规范[list];序号[35];页[4]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 134 | `T-000135 / EV-000609` | listening | P-TEXT | `原始[text]→规范[text];序号[45];页[4]` | `原始[list_item]→规范[list];序号[36];页[4]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 135 | `T-000136 / EV-000610` | listening | P-TEXT | `原始[text]→规范[text];序号[46];页[4]` | `原始[list_item]→规范[list];序号[37];页[4]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 136 | `T-000137 / EV-000611` | listening | P-TEXT | `原始[text]→规范[text];序号[47];页[5]` | `原始[list_item]→规范[list];序号[38];页[5]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 137 | `T-000138 / EV-000612` | listening | P-TEXT | `原始[text]→规范[text];序号[48];页[5]` | `原始[list_item]→规范[list];序号[39];页[5]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 138 | `T-000139 / EV-000613` | listening | P-TEXT | `原始[text]→规范[text];序号[49];页[5]` | `原始[list_item]→规范[list];序号[40];页[5]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 139 | `T-000140 / EV-000614` | listening | P-TEXT | `原始[text]→规范[text];序号[50];页[5]` | `原始[list_item]→规范[list];序号[41];页[5]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 140 | `T-000141 / EV-000615` | listening | P-TEXT | `原始[text]→规范[text];序号[51];页[5]` | `原始[list_item]→规范[list];序号[42];页[5]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 141 | `T-000142 / EV-000616` | listening | P-TEXT | `原始[text]→规范[text];序号[52];页[5]` | `原始[list_item]→规范[list];序号[43];页[5]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 142 | `T-000143 / EV-000617` | listening | P-TEXT | `原始[text]→规范[text];序号[53];页[5]` | `原始[list_item]→规范[list];序号[44];页[5]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 143 | `T-000144 / EV-000618` | listening | P-TEXT | `原始[text]→规范[text];序号[54];页[5]` | `原始[list_item]→规范[list];序号[45];页[5]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 144 | `T-000145 / EV-000619` | listening | P-TEXT | `原始[text]→规范[text];序号[55];页[5]` | `原始[list_item]→规范[list];序号[46];页[5]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 145 | `T-000146 / EV-000620` | listening | P-TEXT | `原始[text]→规范[text];序号[56];页[5]` | `原始[list_item]→规范[list];序号[47];页[5]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 146 | `T-000147 / EV-000621` | listening | P-TEXT | `原始[text]→规范[text];序号[57];页[5]` | `原始[list_item]→规范[list];序号[48];页[5]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 147 | `T-000148 / EV-000622` | listening | P-TEXT | `原始[text]→规范[text];序号[58];页[5]` | `原始[list_item]→规范[list];序号[49];页[5]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 148 | `T-000149 / EV-000623` | listening | P-TEXT | `原始[text]→规范[text];序号[59];页[5]` | `原始[list_item]→规范[list];序号[50];页[5]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 149 | `T-000150 / EV-000625` | listening | P-TEXT | `原始[text]→规范[text];序号[61];页[6]` | `原始[list_item]→规范[list];序号[59];页[6]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 150 | `T-000151 / EV-000627` | listening | P-TEXT | `原始[text]→规范[text];序号[63];页[7]` | `原始[list_item]→规范[list];序号[61];页[7]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 151 | `T-000152 / EV-000628` | listening | P-TEXT | `原始[text]→规范[text];序号[64];页[7]` | `原始[list_item]→规范[list];序号[62];页[7]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 152 | `T-000153 / EV-000629` | listening | P-TEXT | `原始[text]→规范[text];序号[65];页[7]` | `原始[list_item]→规范[list];序号[63];页[7]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 153 | `T-000154 / EV-000630` | listening | P-TEXT | `原始[text]→规范[text];序号[66];页[7]` | `原始[list_item]→规范[list];序号[64];页[7]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 154 | `T-000155 / EV-000631` | listening | P-TEXT | `原始[text]→规范[text];序号[67];页[7]` | `原始[list_item]→规范[list];序号[65];页[7]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 155 | `T-000156 / EV-000634` | listening | P-TEXT | `原始[text]→规范[text];序号[70];页[7]` | `原始[list_item]→规范[list];序号[68];页[7]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 156 | `T-000157 / EV-000640` | listening | P-TEXT | `原始[text]→规范[text];序号[76];页[8]` | `原始[list_item]→规范[list];序号[74];页[8]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 157 | `T-000158 / EV-000641` | listening | P-TEXT | `原始[text]→规范[text];序号[80];页[8]` | `原始[list_item]→规范[list];序号[75];页[8]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 158 | `T-000159 / EV-000652` | listening | P-TEXT | `原始[text]→规范[text];序号[88];页[9]` | `原始[list_item]→规范[list];序号[88];页[9]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 159 | `T-000160 / EV-000653` | listening | P-TEXT | `原始[text]→规范[text];序号[89];页[9]` | `原始[list_item]→规范[list];序号[89];页[9]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 160 | `T-000161 / EV-000654` | listening | P-TEXT | `原始[text]→规范[text];序号[90];页[9]` | `原始[list_item]→规范[list];序号[90];页[9]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 161 | `T-000162 / EV-000655` | listening | P-TEXT | `原始[text]→规范[text];序号[91];页[9]` | `原始[list_item]→规范[list];序号[91];页[9]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 162 | `T-000163 / EV-000656` | listening | P-TEXT | `原始[text]→规范[text];序号[92];页[9]` | `原始[list_item]→规范[list];序号[92];页[9]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 163 | `T-000164 / EV-000657` | listening | P-TEXT | `原始[text]→规范[text];序号[93];页[9]` | `原始[list_item]→规范[list];序号[93];页[9]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 164 | `T-000165 / EV-000658` | listening | P-TEXT | `原始[text]→规范[text];序号[94];页[9]` | `原始[list_item]→规范[list];序号[94];页[9]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 165 | `T-000166 / EV-000659` | listening | P-TEXT | `原始[text]→规范[text];序号[95];页[9]` | `原始[list_item]→规范[list];序号[95];页[9]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 166 | `T-000167 / EV-000660` | listening | P-TEXT | `原始[list]→规范[list];序号[96];页[10]` | `原始[section_header,list_item,list_item]→规范[heading,list,list];序号[96,97,98];页[10,10,10]` | `[list] × [heading,list]` | `SequenceMatcher_non_equal_prefix_group;ok=true` |
| 167 | `T-000168 / EV-000670` | listening | P-TEXT | `原始[text]→规范[text];序号[106];页[11]` | `原始[list_item]→规范[list];序号[108];页[11]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 168 | `T-000169 / EV-000672` | listening | P-TEXT | `原始[text]→规范[text];序号[107];页[11]` | `原始[list_item]→规范[list];序号[109];页[11]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 169 | `T-000170 / EV-000673` | listening | P-TEXT | `原始[text]→规范[text];序号[108];页[11]` | `原始[list_item]→规范[list];序号[110];页[11]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 170 | `T-000171 / EV-000685` | listening | P-TEXT | `原始[text]→规范[text];序号[119];页[13]` | `原始[section_header,text]→规范[heading,text];序号[121,122];页[13,13]` | `[text] × [heading,text]` | `SequenceMatcher_non_equal_prefix_group;ok=true` |
| 171 | `T-000172 / EV-000686` | listening | P-TEXT | `原始[text]→规范[text];序号[120];页[13]` | `原始[section_header,text]→规范[heading,text];序号[123,124];页[13,13]` | `[text] × [heading,text]` | `SequenceMatcher_non_equal_prefix_group;ok=true` |
| 172 | `T-000173 / EV-000687` | listening | P-TEXT | `原始[text]→规范[text];序号[121];页[13]` | `原始[section_header,text]→规范[heading,text];序号[125,126];页[13,13]` | `[text] × [heading,text]` | `SequenceMatcher_non_equal_prefix_group;ok=true` |
| 173 | `T-000174 / EV-000691` | listening | P-TEXT | `原始[index]→规范[index];序号[125];页[14]` | `原始[text,text,text,text,text,text,text]→规范[text,text,text,text,text,text,text];序号[130,131,132,133,135,136,138];页[14,14,14,14,14,14,14]` | `[index] × [text]` | `SequenceMatcher_non_equal_prefix_group;ok=true` |
| 174 | `T-000175 / EV-000699` | listening | P-TEXT | `原始[text]→规范[text];序号[130];页[15]` | `原始[list_item]→规范[list];序号[144];页[15]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 175 | `T-000176 / EV-000700` | listening | P-TEXT | `原始[text]→规范[text];序号[131];页[15]` | `原始[list_item]→规范[list];序号[145];页[15]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 176 | `T-000177 / EV-000701` | listening | P-TEXT | `原始[text]→规范[text];序号[132];页[15]` | `原始[list_item]→规范[list];序号[146];页[15]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 177 | `T-000178 / EV-000702` | listening | P-TEXT | `原始[text]→规范[text];序号[133];页[15]` | `原始[list_item]→规范[list];序号[147];页[15]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 178 | `T-000179 / EV-000703` | listening | P-TEXT | `原始[text]→规范[text];序号[134];页[15]` | `原始[list_item]→规范[list];序号[148];页[15]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 179 | `T-000180 / EV-000704` | listening | P-TEXT | `原始[text]→规范[text];序号[135];页[15]` | `原始[list_item]→规范[list];序号[149];页[15]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 180 | `T-000181 / EV-000705` | listening | P-TEXT | `原始[text]→规范[text];序号[136];页[15]` | `原始[list_item]→规范[list];序号[150];页[15]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 181 | `T-000182 / EV-000706` | listening | P-TEXT | `原始[text]→规范[text];序号[137];页[15]` | `原始[list_item]→规范[list];序号[151];页[15]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 182 | `T-000183 / EV-000707` | listening | P-TEXT | `原始[text]→规范[text];序号[138];页[15]` | `原始[list_item]→规范[list];序号[152];页[15]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 183 | `T-000184 / EV-000708` | listening | P-TEXT | `原始[text]→规范[text];序号[139];页[15]` | `原始[list_item]→规范[list];序号[153];页[15]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 184 | `T-000185 / EV-000709` | listening | P-TEXT | `原始[text]→规范[text];序号[140];页[16]` | `原始[section_header]→规范[heading];序号[154];页[16]` | `[text] × [heading]` | `SequenceMatcher_equal_position;ok=true` |
| 185 | `T-000186 / EV-000712` | listening | P-TEXT | `原始[text]→规范[text];序号[142];页[17]` | `原始[list_item]→规范[list];序号[157];页[17]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 186 | `T-000187 / EV-000713` | listening | P-TEXT | `原始[text]→规范[text];序号[143];页[17]` | `原始[list_item]→规范[list];序号[158];页[17]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 187 | `T-000188 / EV-000714` | listening | P-TEXT | `原始[text]→规范[text];序号[144];页[17]` | `原始[list_item]→规范[list];序号[159];页[17]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 188 | `T-000189 / EV-000715` | listening | P-TEXT | `原始[text]→规范[text];序号[145];页[17]` | `原始[list_item]→规范[list];序号[160];页[17]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 189 | `T-000190 / EV-000721` | listening | P-TEXT | `原始[text]→规范[text];序号[150];页[18]` | `原始[list_item]→规范[list];序号[166];页[18]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 190 | `T-000191 / EV-000723` | listening | P-TEXT | `原始[text]→规范[text];序号[152];页[18]` | `原始[list_item]→规范[list];序号[168];页[18]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 191 | `T-000192 / EV-000726` | listening | P-TEXT | `原始[text]→规范[text];序号[155];页[18]` | `原始[list_item]→规范[list];序号[171];页[18]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 192 | `T-000193 / EV-000727` | listening | P-TEXT | `原始[text]→规范[text];序号[156];页[18]` | `原始[list_item]→规范[list];序号[172];页[18]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 193 | `T-000194 / EV-000728` | listening | P-TEXT | `原始[text]→规范[text];序号[157];页[18]` | `原始[list_item]→规范[list];序号[173];页[18]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 194 | `T-000195 / EV-000729` | listening | P-TEXT | `原始[text]→规范[text];序号[158];页[18]` | `原始[list_item]→规范[list];序号[174];页[18]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 195 | `T-000196 / EV-000730` | listening | P-TEXT | `原始[text]→规范[text];序号[159];页[18]` | `原始[list_item]→规范[list];序号[175];页[18]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 196 | `T-000197 / EV-000758` | listening | P-TEXT | `原始[text]→规范[text];序号[186];页[21]` | `原始[section_header]→规范[heading];序号[182];页[21]` | `[text] × [heading]` | `SequenceMatcher_equal_position;ok=true` |
| 197 | `T-000198 / EV-000771` | listening | P-TEXT | `原始[text]→规范[text];序号[197];页[22]` | `原始[list_item]→规范[list];序号[202];页[22]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 198 | `T-000199 / EV-000772` | listening | P-TEXT | `原始[text]→规范[text];序号[198];页[22]` | `原始[list_item]→规范[list];序号[203];页[22]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 199 | `T-000200 / EV-000774` | listening | P-TEXT | `原始[text]→规范[text];序号[199];页[22]` | `原始[list_item]→规范[list];序号[204];页[22]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 200 | `T-000201 / EV-000783` | listening | P-TEXT | `原始[text]→规范[text];序号[205];页[23]` | `原始[list_item]→规范[list];序号[210];页[23]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 201 | `T-000202 / EV-000784` | listening | P-TEXT | `原始[text]→规范[text];序号[206];页[23]` | `原始[list_item]→规范[list];序号[211];页[23]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 202 | `T-000203 / EV-000785` | listening | P-TEXT | `原始[text]→规范[text];序号[207];页[23]` | `原始[list_item]→规范[list];序号[212];页[23]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 203 | `T-000204 / EV-000786` | listening | P-TEXT | `原始[text]→规范[text];序号[208];页[23]` | `原始[list_item]→规范[list];序号[213];页[23]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 204 | `T-000205 / EV-000787` | listening | P-TEXT | `原始[text]→规范[text];序号[209];页[23]` | `原始[list_item]→规范[list];序号[214];页[23]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 205 | `T-000206 / EV-000788` | listening | P-TEXT | `原始[text]→规范[text];序号[210];页[23]` | `原始[list_item]→规范[list];序号[215];页[23]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 206 | `T-000207 / EV-000789` | listening | P-TEXT | `原始[text]→规范[text];序号[211];页[23]` | `原始[list_item]→规范[list];序号[216];页[23]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 207 | `T-000208 / EV-000790` | listening | P-TEXT | `原始[text]→规范[text];序号[212];页[23]` | `原始[list_item]→规范[list];序号[217];页[23]` | `[text] × [list]` | `SequenceMatcher_equal_position;ok=true` |
| 208 | `T-000209 / EV-000791` | listening | P-TEXT | `原始[text]→规范[text];序号[213];页[23]` | `原始[list_item,text]→规范[list,text];序号[218,219];页[23,24]` | `[text] × [list,text]` | `SequenceMatcher_non_equal_prefix_group;ok=true` |
| 209 | `T-000210 / EV-000795` | listening | P-TEXT | `原始[index]→规范[index];序号[217];页[25]` | `原始[list_item,list_item,list_item,list_item]→规范[list,list,list,list];序号[222,223,224,225];页[25,25,25,25]` | `[index] × [list]` | `SequenceMatcher_non_equal_prefix_group;ok=true` |
| 210 | `T-000211 / EV-000855` | listening | P-TEXT | `原始[index]→规范[index];序号[266];页[33]` | `原始[list_item,list_item,list_item,list_item,list_item,list_item,list_item,list_item,list_item,list_item]→规范[list,list,list,list,list,list,list,list,list,list];序号[295,296,297,298,299,300,301,302,303,304];页[33,33,33,33,33,33,33,33,33,33]` | `[index] × [list]` | `SequenceMatcher_non_equal_prefix_group;ok=true` |
