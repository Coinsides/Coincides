  ...
  return [
    {
      ...
      templates: [
        { template_key: 'text.paragraph', member_role: 'heading', required: false },
        { template_key: 'text.paragraph', member_role: 'concept' },
        { template_key: 'text.paragraph', member_role: 'definition' },
        { template_key: 'text.paragraph', member_role: 'theorem' },
        { template_key: 'text.paragraph', member_role: 'proof' },
        { template_key: 'formula.math', member_role: 'formula' },
        { template_key: 'text.paragraph', member_role: 'example' },
        { template_key: 'text.paragraph', member_role: 'exercise' },
        { template_key: 'text.paragraph', member_role: 'answer', required: false },
        { template_key: 'text.paragraph', member_role: 'callout', required: false },
      ],
      compositions: [
    ...
    },
    {
      ...
      templates: [
        { template_key: 'text.paragraph', member_role: 'heading', required: false },
        { template_key: 'text.paragraph', member_role: 'source_quote' },
        { template_key: 'text.paragraph', member_role: 'claim' },
        { template_key: 'text.paragraph', member_role: 'evidence_example', required: false },
        { template_key: 'text.paragraph', member_role: 'risk_or_conflict', required: false },
      ],
      compositions: [
    ...
    },
    {
      ...
      templates: [
        ...
        { template_key: 'text.paragraph', member_role: 'key_point', required: false },
        { template_key: 'text.paragraph', member_role: 'risk_or_attention', required: false },
        { template_key: 'text.paragraph', member_role: 'action_item', required: false },
      ],
      compositions: [
