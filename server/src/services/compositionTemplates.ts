  ...
  return [
    {
      ...
      slot_schema: [
        { slot_key: 'heading', label: 'Heading', template_keys: ['text.paragraph'], default_template_key: 'text.paragraph', required: false },
        ...
        { slot_key: 'note', label: 'Note', template_keys: ['text.paragraph'], default_template_key: 'text.paragraph', required: false, repeatable: true },
        { slot_key: 'example', label: 'Example', template_keys: ['text.paragraph'], default_template_key: 'text.paragraph', required: false, repeatable: true },
      ],
    ...
    },
    {
      ...
      composition_kind: 'section',
      slot_schema: [
        { slot_key: 'theorem', label: 'Theorem', template_keys: ['text.paragraph'], default_template_key: 'text.paragraph', required: true },
        { slot_key: 'proof', label: 'Proof', template_keys: ['text.paragraph'], default_template_key: 'text.paragraph', required: true },
        { slot_key: 'example', label: 'Example', template_keys: ['text.paragraph'], default_template_key: 'text.paragraph', required: true },
      ],
    ...
    },
    {
      ...
      composition_kind: 'section',
      slot_schema: [
        { slot_key: 'source_quote', label: 'Source Quote', template_keys: ['text.paragraph'], default_template_key: 'text.paragraph', required: true },
        { slot_key: 'interpretation', label: 'Interpretation', template_keys: ['text.paragraph'], default_template_key: 'text.paragraph', required: true },
      ],
    ...
    },
    {
      ...
      composition_kind: 'section',
      slot_schema: [
        { slot_key: 'claim', label: 'Claim', template_keys: ['text.paragraph'], default_template_key: 'text.paragraph', required: true },
        { slot_key: 'evidence', label: 'Evidence', template_keys: ['text.paragraph'], default_template_key: 'text.paragraph', required: true, repeatable: true },
        { slot_key: 'warning', label: 'Warning', template_keys: ['text.paragraph'], default_template_key: 'text.paragraph', required: false },
      ],
    ...
    },
    {
      ...
      composition_kind: 'section',
      slot_schema: [
        { slot_key: 'summary', label: 'Summary', template_keys: ['text.paragraph'], default_template_key: 'text.paragraph', required: true },
        { slot_key: 'key_point', label: 'Key Point', template_keys: ['text.paragraph'], default_template_key: 'text.paragraph', required: false, repeatable: true },
        { slot_key: 'task', label: 'Task', template_keys: ['text.paragraph'], default_template_key: 'text.paragraph', required: false, repeatable: true },
      ],
    ...
    },
    {
      ...
      composition_kind: 'section',
      slot_schema: [
        { slot_key: 'anchor_note', label: 'Anchor Note', template_keys: ['text.paragraph'], default_template_key: 'text.paragraph', required: false },
        { slot_key: 'side_note', label: 'Side Note', template_keys: ['text.paragraph'], default_template_key: 'text.paragraph', required: true, repeatable: true },
      ],
...
function getOrCreateCanvasBackingNote(
  ...
  db.prepare(`
    ...
    VALUES (?, ?, ?, ?, ?, 'proposal', 'canvas_backing', 'system', ?, ?, datetime('now'), datetime('now'))
  `).run(
    id,
    userId,
    canvas.course_id,
