...
-- V14.1 delete ceremony authorizations (migration 075).
-- The authorization service owns the sole update: setting consumed_at once.
...
-- ============================================================
-- V13.3 library boards (migration 057)
-- Soul identity is required and unique. Project is only a nullable search tag.
-- Members are references. Visuals own geometry and lossless extension data.
-- Purpose retirement triggers are installed by migration 057, never here.
-- ============================================================
...
-- V13.4 board-owned text range anchors (migration 059)
...
-- V13.5 named viewport snapshots (migration 066). No board layout or membership state.
