...
import paletteColorRoutes from './routes/paletteColors.js';
import skinSuiteRoutes from './routes/skinSuites.js';
...
import imprintRetrievalRoutes from './routes/imprintRetrieval.js';
...
app.use('/api/palette-colors', authMiddleware, paletteColorRoutes);
app.use('/api/skin-suites', authMiddleware, skinSuiteRoutes);
...
app.use('/api/imprint-retrieval', authMiddleware, imprintRetrievalRoutes);
