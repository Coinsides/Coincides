import {
  ...
  DEFAULT_PRIMARY_PAGE_FRAME_CONTENT_INSET,
} from './engineModel';
...
export const DEFAULT_PAGE_CONTENT_WIDTH = DEFAULT_PRIMARY_PAGE_CONTENT_WIDTH;
export const DEFAULT_PAGE_FRAME_CONTENT_INSET = DEFAULT_PRIMARY_PAGE_FRAME_CONTENT_INSET;
