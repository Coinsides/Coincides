...
type SurfaceMode = 'page' | 'canvas';
type BoundaryKind = 'inside' | 'outside' | 'crossing';
type ExportRole = 'included' | 'excluded' | 'scratch';
type AIVisibility = 'visible' | 'hidden';

const NOTE_LAYOUT_KEY = 'better_notebook_layout';
const DEFAULT_PAGE_CONTENT_WIDTH = DEFAULT_PRIMARY_PAGE_FRAME.width;
const CANVAS_WORKSPACE_WIDTH = DEFAULT_CANVAS_WORLD.width;
const CANVAS_WORKSPACE_HEIGHT = DEFAULT_CANVAS_WORLD.height;
const CANVAS_PAGE_OFFSET_X = CANVAS_PRIMARY_PAGE_OFFSET_X;
const DEFAULT_BLOCK_HEIGHT = 72;
const DEFAULT_BLOCK_GAP = 0;
const STACKED_BLOCK_GAP = 0;
const MIN_BLOCK_WIDTH = 36;
const MIN_BLOCK_HEIGHT = 42;
const SNAP_THRESHOLD = 8;
const ELASTIC_AVOIDANCE_ACTIVATION_DISTANCE = 10;
const LAYOUT_MEASURE_SUPPRESSION_MS = 350;
const SLASH_MENU_WIDTH = 420;
const SLASH_MENU_HEIGHT_ESTIMATE = 320;
const SLASH_MENU_OFFSET = 8;
const BLOCK_HORIZONTAL_CHROME = 18;
const BLOCK_VERTICAL_CHROME = 16;
const TEXT_LINE_HEIGHT = 27;
const TEXT_AVERAGE_CHAR_WIDTH = 8.2;
