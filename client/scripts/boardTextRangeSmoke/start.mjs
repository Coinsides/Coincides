...
const server = await createServer({
  ...
  plugins: [{
    name: 'board-text-range-smoke-memory-api', enforce: 'pre',
...
await server.listen();
console.log('Synthetic text range smoke: http://127.0.0.1:5184/scripts/boardTextRangeSmoke/index.html#/notes/range-smoke-note');
